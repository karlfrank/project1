...
-- --------------------------------------------------
-- Date Created: 12/15/2016 21:02:51
...
-- Creating foreign key on [PositionTypeId] in table 'Person'
ALTER TABLE [dbo].[Person]
ADD CONSTRAINT [FK_PositionTypePerson]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_PositionTypePerson'
CREATE INDEX [IX_FK_PositionTypePerson]
ON [dbo].[Person]
    ([PositionTypeId]);
GO
